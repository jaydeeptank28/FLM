// File List Page - Production API Version
...
function FileListPage() {
    ...
    const { fetchFilesByFolder, loading } = useFiles();
    ...
    useEffect(() => {
        const loadFiles = async () => {
            setIsLoading(true);
            try {
                const result = await fetchFilesByFolder(folder);
                setFiles(result);
            } catch (error) {
                            ...
                            <TableBody>
                                {files.map((file) => (
                                    ...
                                    >
                                        ...
                                        <TableCell>
                                            <Chip label={file.file_type || file.fileType} size="small" variant="outlined" />
                                        </TableCell>
                                        <TableCell>{file.department_code || file.department}</TableCell>
                                        <TableCell>
                                        ...
                                        <TableCell>
                                            <Typography variant="body2">{file.created_by_name || 'Unknown'}</Typography>
                                        </TableCell>
                                        <TableCell>
                                            <Typography variant="body2" color="text.secondary">
