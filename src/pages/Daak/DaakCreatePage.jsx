...
function DaakCreatePage() {
    ...
    const { createDaak, generateDaakNumber } = useDaak();
    ...
    const handleSubmit = async () => {
        ...
        setLoading(true);
        try {
            const daak = createDaak(formData);
    ...
    const previewDaakNumber = generateDaakNumber(formData.type);
                    ...
                    <Card>
                        <CardContent sx={{ p: 3 }}>
                            ...
                            <Typography variant="body2" sx={{ mb: 3, textAlign: 'center', color: 'primary.main' }}>
                                <strong>Daak Number:</strong> {previewDaakNumber}
                            </Typography>
