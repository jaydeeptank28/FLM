...
function FileCreatePage() {
    ...
    const { createFile, performWorkflowAction, generateFileNumber } = useFiles();
    ...
    const handleSaveDraft = async () => {
        ...
        setLoading(true);
        try {
            const file = createFile(formData);

            // Add documents if any
            documents.forEach(doc => {
                // In real app, would upload file here
                // For demo, just adding metadata
            });
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            // Submit the file
            performWorkflowAction(file.id, WORKFLOW_ACTIONS.SUBMIT);
    ...
    const previewFileNumber = formData.department ? generateFileNumber(formData.department) : 'FLM/XXX/YYYY/NNNN';
                            ...
                            <Grid container spacing={3}>
                                ...
                                <Grid item xs={12}>
                                    <Alert severity="info" icon={<FileIcon />}>
                                        <strong>File Number:</strong> {previewFileNumber}
                                    </Alert>
                                </Grid>
